...
bool Solution::readRootPath(String& path) {return iniFile.read(IniSection, RootPathKey, path, _T(""));}
...
bool Solution::getRootPath(String& path) {return getDirPathDlg(_T("Project Root Directory"), path);}

...
void WixAppDlg::onDelFeature()       {features.reloadCB(*this);       UpdateWindow();}
...
void WixAppDlg::onChangeComponent()
                                {features.getCurFeature()->changeComponent(*this); UpdateWindow();}
void WixAppDlg::onLeavingComponent() {features.getCurFeature()->storeComponentData(*this);}
void WixAppDlg::onNewComponent()
                                {features.getCurFeature()->newComponent(*this);    UpdateWindow();}
...
void WixAppDlg::onBrowseForIcon()
         {features.getCurComponent()->getIconPath(*this); updateCtrlPanelIconCB(); UpdateWindow();}

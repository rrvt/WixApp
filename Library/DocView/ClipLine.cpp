...
void ClipLine::clipRegion(TCchar* txt, int xPos, int w, VertMgmt& vert, DeviceContext& dvx) {
int y0 = vert.pos();
...
void ClipLine::open(DeviceContext& dvx) {
...
void ClipLine::close(DeviceContext& dvx) {

...
void EntRcd::clear() {
  ...
  id = addrID = cityStID = addrIsPO = 0;   dirty = remove = false;
  firstName.clear();   middleInitial.clear();   lastName.clear();
  suffix.clear();      locationZip.clear();     eMail.clear();
  phone1.clear();      phone2.clear();
  }

...
String addSepTab(String& s,  int max);   // Add comma to non-null string followed by spaces out to
                                         // max
...
String nextTok(String& s, int& pos);    // return next token in string after pos delimited by a
                                        // comma or end of string, modify pos to beginning of next
                                        // token
